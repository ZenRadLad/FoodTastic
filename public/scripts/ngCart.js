...
angular.module('ngCart', ['ngCart.directives'])
    ...
    .service('ngCart', ['$rootScope', 'ngCartItem', 'store', function ($rootScope, ngCartItem, store) {
        ...
        this.addItem = function (id, name, price, quantity, data, category) {
            ...
            if (typeof inCart === 'object'){
                ...
                var newItem = new ngCartItem(id, name, price, quantity, data, category);
        ...
        this.$restore = function(storedCart){
            ...
            angular.forEach(storedCart.items, function (item) {
                _self.$cart.items.push(new ngCartItem(item._id,  item._name, item._price, item._quantity, item._data, item._category));
            });
            this.$save();
        };
    ...
    .factory('ngCartItem', ['$rootScope', '$log', function ($rootScope, $log) {
        ...
        var item = function (id, name, price, quantity, data, category) {
            this.setId(id);
            this.setName(name);
            this.setPrice(price);
...
.service('ngCart.fulfilment.http', ['$http', 'ngCart', function($http, ngCart, $location, $rootScope){
